...
class YTDownloader {
    ...
    static search = async (query, options = {}) => {
        const search = await yts.search({ query, ...options, hl: 'en', gl: 'US' })
    ...
    static downloadMusic = async (query) => {
        try {
            ...
            const videoInfo = await ytdl.getInfo('https://www.youtube.com/watch?v=' + search.id, { lang: 'en' });
    ...
    static mp4 = async (query, quality = 134) => {
        try {
            ...
            const videoInfo = await ytdl.getInfo('https://www.youtube.com/watch?v=' + videoId, { lang: 'en' });
    ...
    static mp3 = async (url, metadata = {}, autoWriteTags = false) => {
        try {
            ...
            const { videoDetails } = await ytdl.getInfo(url, { lang: 'en' });
